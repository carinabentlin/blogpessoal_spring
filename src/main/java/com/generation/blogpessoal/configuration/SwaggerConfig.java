    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Projeto Blog Pessoal by Carina Bentlin - Generation Brasil")
                .version("v0.0.1")
                .license(new License()
                ...
                .contact(new Contact()
                    .name("Carina Bentlin")
                    .url("https://github.com/carinabentlin/blogpessoal_spring")
                    .email("carinabentlin@gmail.com")))
