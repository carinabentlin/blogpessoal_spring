...
public class UsuarioService {
	...
	@Autowired
	private JwtService jwtService;  //a partir de usuario service, podemos chamar o metodo gerar token

	@Autowired
	private AuthenticationManager authenticationManager; //autentica o usuario e senha
